# Resolve — Instagram Draft

## Comparison
The core body copy remains the same as the original source, but the release date line at the bottom is now stale relative to the current rollout plan. The admin plan should be treated as the source of truth for scheduling.
